...
public class CountDownView extends View {
    ...
    public CountDownView(Context context, AttributeSet attrs) {
        ...
        borderWidth = ta.getDimension(R.styleable.CountDownView_cd_border_width, BORDER_WIDTH);
        borderColor = ta.getColor(R.styleable.CountDownView_cd_border_color, BORDER_COLOR);
...
//        canvas.translate(width / 2, height / 2);
    ...
    public void start() {
        ...
        if (countDownTimer == null) {
            countDownTimer = new CountDownTimer(MAX_TIME, DURATION) {
                @Override
                public void onTick(long millisUntilFinished) {
                    progress = ((MAX_TIME - millisUntilFinished) / 3600f) * 360;
//                    int countTime = (int) (millisUntilFinished / 100);
//                    text = countTime + "s";
                    Log.e("progress", "countTime:" + millisUntilFinished);
